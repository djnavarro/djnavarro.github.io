...
add_card(
  ...
  text = "I write a data science blog, \"Notes from a data witch\". It covers a variety of topics including R, Python, Linux, and many other things related to data analysis workflows. Sometimes this is useful, mostly it's a time-sink.",
...
add_card(
  ...
  text = "I have a generative art website where I post various art series under creative commons licences. For some series the source code is also available on github. There's no AI in this, it's the other kind of generative art.",
...
add_card(
  ...
  title = "Academic work", 
  text = "In a former life I was an academic. I've not yet succeeded in repressing all the memories of the experience, and out of habit I still keep an archive of my scientific papers.",
...
add_card(
  src = "image/code-advent.png",
  title = "Code, software, et cetera", 
  text = "I write code sometimes, and it is... fine :)",
  url = "https://code.djnavarro.net",
  img_alt = "Abstract geometric art with a kind of mechanistic vibe",
  link_text = "code.djnavarro.net"
)
