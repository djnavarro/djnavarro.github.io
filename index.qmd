...
::: {.banner}
![](danielle.jpg){width=300px fig-align="center" class="circular" fig.alt="Profile photo of the author, tightly cropped so that only some of my face is visible, edited to superimpose ghostly images of R package stickers that are only visible in some parts of the image."}
...
add_card(
  ...
  img_alt = "Three watercolour-style hexagons in red, yellow, and blue, against a dark grey background. Overlaying this is text reading 'Art From Code'.",
...
add_card(
  ...
  img_alt = "The title of the book, 'Learning Statistics with R', agains a background of jasmine flowers",
...
add_card(
  ...
  img_alt = "Text reading 'Data science slide decks' in cursive font, against a background showing old-fashiond projector slides.",
...
<a rel="me" style="display:none" href="https://fosstodon.org/@djnavarro"></a> 
<a rel="me" style="display:none" href="https://genart.social/@djnavarro"></a>
